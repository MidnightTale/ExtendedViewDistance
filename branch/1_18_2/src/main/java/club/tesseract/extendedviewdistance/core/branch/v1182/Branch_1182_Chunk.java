...
public final class Branch_1182_Chunk implements BranchChunk {
    private final ChunkAccess chunkAccess;
    private final ServerLevel worldServer;


    public Branch_1182_Chunk(ServerLevel worldServer, ChunkAccess chunkAccess) {
    ...
    public BranchNBT toNBT(BranchChunkLight light, List<Runnable> asyncRunnable) {
        return new Branch_1182_NBT(Branch_1182_ChunkRegionLoader.saveChunk(worldServer, chunkAccess, (Branch_1182_ChunkLight) light, asyncRunnable));
    }
