...
public final class Branch_1201_PacketHandleLightUpdate {

  public Branch_1201_PacketHandleLightUpdate() {}

  public void write(FriendlyByteBuf serializer, Branch_1201_ChunkLight light) {
  ...
  private static void saveBitSet(
    ...
    if (nibbleArray != Branch_1201_ChunkLight.EMPTY) {
      if (nibbleArray == null) {
        isEmpty.set(index);
      } else {
        notEmpty.set(index);
