...
public final class Branch_1201_ChunkLight implements BranchChunkLight {
  ...
  public Branch_1201_ChunkLight(World world) {
    this(((CraftWorld) world).getHandle());
  }

  public Branch_1201_ChunkLight(ServerLevel worldServer) {
    this(
      worldServer,
