...
public final class Branch_14_Chunk implements BranchChunk {
    ...
    public Branch_14_Chunk(WorldServer worldServer, IChunkAccess chunkAccess) {
    ...
    public BranchNBT toNBT(BranchChunkLight light, List<Runnable> asyncRunnable) {
        return new Branch_14_NBT(Branch_14_ChunkRegionLoader.saveChunkQuick(worldServer, chunkAccess, (Branch_14_ChunkLight) light, asyncRunnable));
    }
    ...
    public org.bukkit.block.Biome getBiome(int x, int y, int z) {
        return CraftBlock.biomeBaseToBiome(chunkAccess.getBiome(new BlockPosition(x, 0, z)));
    }
    ...
    public void setBiome(int x, int y, int z, org.bukkit.block.Biome biome) {
        chunkAccess.getBiomeIndex()[(z & 15) << 4 | (x & 15)] = CraftBlock.biomeToBiomeBase(biome);
    }

    public boolean hasFluid(int x, int y, int z) {
        return !getIBlockData(x, y, z).p().isEmpty();
    }
