...
public final class Branch_14_ChunkLight implements BranchChunkLight {
    ...
    public Branch_14_ChunkLight(World world) {
        this(((CraftWorld) world).getHandle());
    }
    public Branch_14_ChunkLight(WorldServer worldServer) {
        this(worldServer, new byte[18][], new byte[18][]);
    }
    public Branch_14_ChunkLight(WorldServer worldServer, byte[][] blockLights, byte[][] skyLights) {
