...
public final class Branch_1202_PacketHandleLightUpdate {
  ...
  public Branch_1202_PacketHandleLightUpdate() {}

  public void write(FriendlyByteBuf serializer, Branch_1202_ChunkLight light) {
  ...
  private static void saveBitSet(
    ...
    if (nibbleArray != Branch_1202_ChunkLight.EMPTY) {
      if (nibbleArray == null) {
        isEmpty.set(index);
      } else {
        notEmpty.set(index);
