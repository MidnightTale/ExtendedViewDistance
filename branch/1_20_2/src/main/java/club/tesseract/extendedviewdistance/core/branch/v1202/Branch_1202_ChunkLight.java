...
public final class Branch_1202_ChunkLight implements BranchChunkLight {
  ...
  public Branch_1202_ChunkLight(World world) {
    this(((CraftWorld) world).getHandle());
  }

  public Branch_1202_ChunkLight(ServerLevel worldServer) {
    this(
      worldServer,
