...
public final class Branch_1204_ChunkLight implements BranchChunkLight {
  ...
  public Branch_1204_ChunkLight(World world) {
    this(((CraftWorld) world).getHandle());
  }

  public Branch_1204_ChunkLight(ServerLevel worldServer) {
    this(
      worldServer,
