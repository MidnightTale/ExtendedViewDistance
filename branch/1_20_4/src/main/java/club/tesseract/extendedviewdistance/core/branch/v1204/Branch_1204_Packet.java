...
public final class Branch_1204_Packet implements BranchPacket {

  private final Branch_1204_PacketHandleChunk handleChunk = new Branch_1204_PacketHandleChunk();
  private final Branch_1204_PacketHandleLightUpdate handleLightUpdate = new Branch_1204_PacketHandleLightUpdate();
  ...
  public Consumer<Player> sendChunkAndLight(
    ...
    this.handleChunk.write(
        serializer,
        ((Branch_1204_Chunk) chunk).getLevelChunk(),
        needTile
      );
    this.handleLightUpdate.write(serializer, (Branch_1204_ChunkLight) light);
