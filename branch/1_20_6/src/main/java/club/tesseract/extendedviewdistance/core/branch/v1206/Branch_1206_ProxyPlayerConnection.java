...
public final class Branch_1206_ProxyPlayerConnection {
  ...
  static {
    try {
      field_PacketPlayOutUnloadChunk_chunkPos =
        ClientboundForgetLevelChunkPacket.class.getDeclaredField("pos");
      field_PacketPlayOutViewDistance_distance =
        ClientboundSetChunkCacheRadiusPacket.class.getDeclaredField("radius");
