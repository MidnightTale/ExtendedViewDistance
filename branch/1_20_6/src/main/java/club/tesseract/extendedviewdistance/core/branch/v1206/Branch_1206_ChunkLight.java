...
public final class Branch_1206_ChunkLight implements BranchChunkLight {
  ...
  public Branch_1206_ChunkLight(World world) {
    this(((CraftWorld) world).getHandle());
  }

  public Branch_1206_ChunkLight(ServerLevel worldServer) {
    this(
      worldServer,
