...
public final class Branch_15_ChunkLight implements BranchChunkLight {
    ...
    public Branch_15_ChunkLight(World world) {
        this(((CraftWorld) world).getHandle());
    }
    public Branch_15_ChunkLight(WorldServer worldServer) {
        this(worldServer, new byte[18][], new byte[18][]);
    }
    public Branch_15_ChunkLight(WorldServer worldServer, byte[][] blockLights, byte[][] skyLights) {
