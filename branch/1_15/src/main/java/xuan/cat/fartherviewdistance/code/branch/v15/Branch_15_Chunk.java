...
public final class Branch_15_Chunk implements BranchChunk {
    private final IChunkAccess  chunkAccess;
    private final WorldServer   worldServer;


    public Branch_15_Chunk(WorldServer worldServer, IChunkAccess chunkAccess) {
    ...
    public BranchNBT toNBT(BranchChunkLight light, List<Runnable> asyncRunnable) {
        return new Branch_15_NBT(Branch_15_ChunkRegionLoader.saveChunkQuick(worldServer, chunkAccess, (Branch_15_ChunkLight) light, asyncRunnable));
    }
    ...
    public org.bukkit.block.Biome getBiome(int x, int y, int z) {
        ...
        return biomeStorage != null ? CraftBlock.biomeBaseToBiome(biomeStorage.getBiome(x, y, z)) : null;
    }
    ...
    public void setBiome(int x, int y, int z, org.bukkit.block.Biome biome) {
        ...
        if (biomeStorage != null)
            biomeStorage.setBiome(x, y, z, CraftBlock.biomeToBiomeBase(biome));
    }
    ...
    public int getHighestY(int x, int z) {
        return chunkAccess.a(HeightMap.Type.MOTION_BLOCKING, x, z);
    }
